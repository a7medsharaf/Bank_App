...
function Validate_Transaction(req, res) {
    return __awaiter(this, void 0, void 0, function () {
        var transaction, account, TR, ResSent, card, client, payment_account, TID_Debit, newbalance, operation_date_time, user_auth, err_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.trys.push([1, 3, , 4]);
                    return [4 /*yield*/, (0, Login_Controller_1.check_user)(req)];
                case 2:
                    user_auth = _a.sent();
                    if (!user_auth) {
                        TR.accepted = false;
